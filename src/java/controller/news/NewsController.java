...
//        String categoryIdParam = request.getParameter("categoryId");
        ...
        //Lấy blog cho từng danh mục và gán vào từng loại
        for (NewsType type : types) {
            List<News> blogses = db.getNewsByCategory(type.getId());
            type.setNews(blogses);
        }
        request.setAttribute("type", types);
        request.getRequestDispatcher("./view/sale/news.jsp").forward(request, response);
