...
public class SendEmail {
    ...
    public static void sendMail(String sentTo, String title, String content) {
        ...
        final String username = "hoangnhhe170292@fpt.edu.vn";
        final String password = "adoa onrl ujsw wlxw";
    ...
    public static void main(String[] args) {
        SendEmail.sendMail("toantthe172722@fpt.edu.vn", "hello TPA", "<h1>qua dep</h1>");
    }
}
