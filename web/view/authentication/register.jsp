                    ...
                    <div class="col-lg-6 offset-lg-3 col-12">
                        <div class="login-form">
                            ...
                            <form class="form" method="POST" action="register" id="registerForm">
                                <!--If the user registers with Google, the registered email will be added to the database in the servlet-->
                                <c:if test="${registerGoogle ne null}">
                                    <input name="registerGoogle" type="hidden" value="registerGoogle">
                                </c:if>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            <input name="dob" id="dob" value="${dob}" type="date"> 
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="">
                                            <c:if test="${gender}">checked</c:if>
                                            <input name="gender" type="radio" value="male" <c:if test="${gender}">checked</c:if>> Nam 
                                            <input name="gender" type="radio" value="female" <c:if test="${!gender}">checked</c:if>> Nữ
                                            </div>
                                        </div>
                                        <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            <input name="address" id="address" value="${address}" type="text" class="form-control" placeholder="Nhập địa chỉ" required>
                                    ...
                                    <c:if test="${registerGoogle eq null}">
                                        <div class="col-12">
                                            <label>Tài khoản<span style="color: red">*</span></label>
                                            <div class="form-group">
                                                <input name="username" id="username" value="${username}" type="text" class="form-control" placeholder="Nhập tài khoản" maxlength="15" required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="form-group">
                                                <input name="password" id="password" type="password" class="form-control" placeholder="Nhập mật khẩu" maxlength="15" required>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <label>Nhập lại mật khẩu<span style="color: red">*</span></label>
                                            <div class="form-group">
                                                <input name="cfpassword" id="cfpassword" type="password" class="form-control" placeholder="Nhập mật khẩu" maxlength="15" required>
        ...
        <script>
                                        document.addEventListener('DOMContentLoaded', function () {
                                            ...
                                            function validatePasswordMatch() {
                                                if (password && cfpassword && passwordError) {
                                                    if (password.value === "" || cfpassword.value === "") {
                                                        passwordError.textContent = "Mật khẩu không được để trống!";
                                                        return false;
                                                    }
                                                    if (password.value !== cfpassword.value) {
                                                        passwordError.textContent = "Mật khẩu không trùng nhau!";
                                                        return false;
                                                    } else {
                                            ...
                                            if (username && password && cfpassword) {
                                                username.addEventListener('input', function () {
                                                    validateNoSpaces(username, usernameError);
                                                });
                                                password.addEventListener('input', function () {
                                                    validateNoSpacesAndPassword(password, passwordError);
                                                });
                                                cfpassword.addEventListener('input', function () {
                                                    validateNoSpacesAndPassword(cfpassword, passwordError);
                                                });
                                            }
                                            ...
                                            function validateForm() {
                                                ...
                                                var isDobValid = isAtLeast6YearsOld(dob, dobError);
                                                var isEmailValid = validateEmailAndNoSpaces(email, emailError);
                                                var isAddressValid = validateNoSpacesStartEnd(address, addressError);
                                                var isPhoneValid = validatePhoneAndNoSpaces(phone, phoneError);
                                                var isUsernameValid = validateNoSpaces(username, usernameError);
                                                var isPasswordValid = validateNoSpacesAndPassword(password, passwordError);
                                                var isCfPasswordValid = validateNoSpacesAndPassword(cfpassword, passwordError);
                                                return isNameValid && isDobValid && isEmailValid && isAddressValid
                                                        && isPhoneValid && isUsernameValid && isPasswordValid && isCfPasswordValid;
                                            }
