...
<body>
    ...
    <aside class="app-sidebar" id="sidebar">
        <div class="app-sidebar__user">
            ...
            <div>
                <p class="app-sidebar__user-name"><b>Quản trị Manager</b></p>
                <p class="app-sidebar__user-designation">Chào mừng bạn trở lại</p>
            </div>
        </div>
        <hr>
        <ul class="app-menu">
            <li><a class="app-menu__item haha" href="${pageContext.request.contextPath}/homepagemanager"><i class='app-menu__icon bx bx-home'></i>
                    <span class="app-menu__label">Trang chủ</span></a></li>
            <li><a class="app-menu__item" href="${pageContext.request.contextPath}/manager/listproduct"><i class='app-menu__icon bx bx-box'></i>
                    <span class="app-menu__label">Quản lý sản phẩm</span></a></li>
            <li><a class="app-menu__item" href="${pageContext.request.contextPath}/manager/listdiscount"><i class='app-menu__icon bx bx-purchase-tag'></i><span
                        class="app-menu__label">Quản lý khuyến mại</span></a></li>
            <li><a class="app-menu__item" href="${pageContext.request.contextPath}/top10product"><i class='app-menu__icon bx bx-cart'></i><span
                        class="app-menu__label">Top 10 sản phẩm</span></a></li>
